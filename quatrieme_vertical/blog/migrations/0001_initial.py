# Generated by Django 2.2.11 on 2020-05-07 09:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Utilisateur')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to='static/blog/uploads/% Y/% m/% d/')),
        ...
        migrations.AddField(
            model_name='comment',
            name='utilisateur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Utilisateur'),
        ),
        migrations.AddField(
            model_name='article',
            name='category',
